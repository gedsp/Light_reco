...
float get_S2_gaus(TH1F *h_plot, double &s2_width, double &tau_S2, double &amp_S2, double ped)
{
		TF1 *S2_gaus;	    
...
float get_S2(TH1F *h, double &s2_width, double &tau_S2, double &amp_S2, int binpeak, double s1_width, double ped)
{
